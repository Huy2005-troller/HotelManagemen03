...
namespace HotelManagement.Models
{
    public partial class HotelContext : DbContext
    {
        ...
        public virtual DbSet<HoaDonDoHong> HoaDonDoHongs { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HoaDonDoHong>(entity =>
            {
                entity.HasKey(e => e.Id)
                    .HasName("PK__Hoa_Don_Do_Hong__Id");

                entity.ToTable("Hoa_Don_Do_Hong");

                entity.Property(e => e.Id).ValueGeneratedOnAdd();

                entity.Property(e => e.MaHoaDon).HasMaxLength(255);

                entity.Property(e => e.TenDoHong).HasMaxLength(255);

                entity.HasOne(d => d.MaHoaDonNavigation)
                    .WithMany(p => p.HoaDonDoHongs)
                    .HasForeignKey(d => d.MaHoaDon)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_HoaDonDoHong_HoaDon");
            });
